...
CI/CD runs builds, tests, and basic checks on pull requests. Merges to main build and deploy containers via EC2 to staging and production using rolling or blue-green deployments.
